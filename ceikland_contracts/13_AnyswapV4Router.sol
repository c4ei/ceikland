...
https://snowtrace.io/address/0xe5CF1558A1470cb5C166c2e8651eD0F3c5fb8F42#code
Contract Name: AnyswapV4Router
Compiler Version: v0.8.1+commit.df193b15
Optimization Enabled: Yes with 200 runs
Other Settings: default evmVersion, None license

13_AnyswapV4Router.sol
#############################################################
contract address : 0x15f47D4674ea6516e55dF8b958DceB09587F0B54 (220925)
#############################################################
-----Decoded View---------------
Arg [0] : _factory (address): 0xDB19Fda3888868E1011d9EF324586FCFae7059b6
Arg [1] : _wNATIVE (address): 0x359CB4B1a62879827A6016384696c6bd680C8476 (WC4EI)
Arg [2] : _mpc (address): 0x6245e28Fe45B543c1F93e65c0997114d4Ba0F39c
*/
...
library SushiswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint256(keccak256(abi.encodePacked(
                ...
                hex'52fb4943439d3c270779d5b40b8b754a358963aa6af8e775494afa38dc9a3804' // init code hash
