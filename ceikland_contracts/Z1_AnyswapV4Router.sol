/**
https://etherscan.io/address/0x765277eebeca2e31912c9946eae1021199b39c61#code
...
library SushiswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint256(keccak256(abi.encodePacked(
                ...
                // hex'e18a34eb0e04b04f7a0ac29a6e80748dca96319b42c54d679cb821dca90c6303' // init code hash SushiswapV2Library
                hex'76b90679d2026f950aa211a0f679a92ffca5326a3ef3fcfe5469abfd8d0991ea' // init code hash PancakeLibrary
            )))));
    }
